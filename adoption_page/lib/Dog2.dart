...
class Dog2screen extends StatelessWidget{
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text("Lola",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                  SizedBox(
                    width: 20,
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Text("Mulund, Mumbai",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                ],
              ),
            ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("Gaurav Kulkarni",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700),),
                      SizedBox(
                        height: 5,
                      ),
