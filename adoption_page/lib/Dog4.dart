...
class Dog4screen extends StatelessWidget{
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text("Ace",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                  SizedBox(
                    width: 20,
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Text("Bhandup, Mumbai",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                ],
              ),
            ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("white",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          ],
                        )
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("2 Mths",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          ],
                        )
                      ),
                    ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("Vivek Bhagwat",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700),),
                      SizedBox(
                        height: 5,
                      ),
