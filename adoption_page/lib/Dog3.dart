...
class Dog3screen extends StatelessWidget{
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text("Rockey",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                  SizedBox(
                    width: 20,
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Text("Chembur, Mumbai",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                ],
              ),
            ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("Black",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          ],
                        )
                      ),
                    ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("Niranjan Joshi",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700),),
                      SizedBox(
                        height: 5,
                      ),
