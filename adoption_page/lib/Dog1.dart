...
class Dog1screen extends StatelessWidget{
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text("Jack",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                  SizedBox(
                    width: 20,
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Text("Thane, Mumbai",style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),)],
                  ),
                ],
              ),
            ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("3 Mths",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          ],
                        )
                      ),
                    ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("Vijay Shinde",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700),),
                      SizedBox(
                        height: 5,
                      ),
